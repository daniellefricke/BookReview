...
var reviews = [review1, review2, review3, review4, review5, review6, review7, review8, review9, review9]
...
books.forEach((book, i) => {
  ...
  //   } else {
  //     console.log("" + book.title + " saved successfully. " + ++successCount + " saves thus far");
  //   }
  // })
})
...
Book.remove({}).then(function(){
  Book.collection.insert(books).then(function(res){
    console.log(res);
    process.exit();
  });
});
